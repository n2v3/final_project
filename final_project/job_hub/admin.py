...
class EmployerAdmin(admin.ModelAdmin):
    list_display = ('employer_first_name', 'employer_last_name', 'email', 'position')
    search_fields = ('employer_first_name', 'employer_last_name', 'email', 'position')

@admin.register(CompanyProfile)
class CompanyProfileAdmin(admin.ModelAdmin):
    list_display = ('company_name', 'website', 'location', 'amount_of_employees')
    search_fields = ('company_name', 'website', 'location__location_name')

@admin.register(Vacancy)
class VacancyAdmin(admin.ModelAdmin):
    list_display = ('job_title', 'description', 'salary', 'company_profile', 'category')
    search_fields = ('job_title', 'description', 'salary__salary_range_start', 'company_profile__company_name', 'category__category_name')
