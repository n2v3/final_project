    ...
    def authenticate(self, request):
        ...
        try:
            ...
            if get_params.get("password") == "zxcv1234":
                # If condition is met, return the user and no credentials
                return user, None
            else:
                # If condition is not met, return None to indicate authentication failure
                return None, None
        except User.DoesNotExist:
            # If the user does not exist, return None to indicate authentication failure
            return None, None
